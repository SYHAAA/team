    ...
    <div class="test_main">
        <div class="nr_left">
            <div style="height: 80px;">
                <h3 style="text-align: center">试卷满分：${exam.examGrade}&nbsp;&nbsp;&nbsp;&nbsp;总分：${examRecord.objectiveSource+examRecord.subjectiveSource}&nbsp;&nbsp;&nbsp;&nbsp;客观题得分：${examRecord.objectiveSource}&nbsp;&nbsp;&nbsp;&nbsp;主观题得分：
            ...
            <div class="test">
                ...
                <form id="userExam" action="/source/updateSource.action" method="post">
                    <input type="hidden" name="historyId" value="${exam.examId}">
                    <input type="hidden" name="userId" value="${examRecord.userId}">
                    <div class="test_title">
                        ...
                        <font><input type="submit" name="test_jiaojuan" id="tj" value="评阅"/></font>
                    </div>
                            ...
                            <c:forEach items="${answer}" var="a" varStatus="aw">
                                ...
                                <div class="test_content_nr_main">
                                    <ul>
                                        ...
                                        <li>得分：<input type="text" autocomplete="off" name="userAnswer${aw.index}"></li>
                                    </ul>
                                </div>
                            </c:forEach>
                        </ul>
